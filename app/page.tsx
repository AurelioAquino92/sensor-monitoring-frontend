...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen items-start justify-between p-0 bg-white font-sans">
      ...
      <div className="flex flex-col grow p-10 gap-4 min-h-screen max-h-screen overflow-hidden">
        {eventoSelecionado &&
